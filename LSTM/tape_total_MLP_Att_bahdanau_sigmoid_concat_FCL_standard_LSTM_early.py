...
for num in range(131,141) :
    ...
    class Encoder(keras.layers.Layer) :
        def __init__(self, name="encoder"):
            ...
            self.lstm2 = keras.layers.LSTM(256, return_sequences=True, kernel_initializer='he_normal')
    ...
    # pd.DataFrame(corr_list).to_pickle('./bahda_lstm1_{}/corrlist_{}.csv'.format(ENERGY, num))
