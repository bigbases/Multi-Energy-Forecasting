...
for num in range(100,105) :
    ...
    class AttentionModel(keras.Model):
        def __init__(self, name="attentionmodel"):
            ...
            self.encoder1 = TCN(nb_filters=24, kernel_size=3, dilations=(1, 3, 9, 27))
            self.encoder2 = TCN(nb_filters=24, kernel_size=3, dilations=(1, 3, 9, 27))
            self.encoder3 = TCN(nb_filters=24, kernel_size=3, dilations=(1, 3, 9, 27))
            self.encoder4 = TCN(nb_filters=24, kernel_size=3, dilations=(1, 3, 9, 27))
            self.encoder5 = TCN(nb_filters=24, kernel_size=3, dilations=(1, 3, 9, 27))
            self.corr = Corr()
